...
inherit allarch useradd agl-graphical
...
USERADD_PARAM_${PN} = "\
  ...
  --gid ${WESTONGROUP} --groups weston-launch,video,input --home-dir /run/platform/${WESTONUSER} --shell /bin/false --comment \"Display daemon\" --key PASS_MAX_DAYS=-1 ${WESTONUSER} \
"
